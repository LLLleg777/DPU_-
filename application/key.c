...
{	   
	...
	if(HAL_GPIO_ReadPin(KEY0_GPIO_Port,GPIO_PIN_9)==0||
		 HAL_GPIO_ReadPin(KEY1_GPIO_Port,GPIO_PIN_8)==0||
	   HAL_GPIO_ReadPin(KEY2_GPIO_Port,GPIO_PIN_7)==0||
	   HAL_GPIO_ReadPin(KEY3_GPIO_Port,GPIO_PIN_6)==0)   //有键正按下
	{
		if(HAL_GPIO_ReadPin(KEY0_GPIO_Port,GPIO_PIN_9)==0)      key_tem=1;
		else if(HAL_GPIO_ReadPin(KEY1_GPIO_Port,GPIO_PIN_8)==0) key_tem=2;
		else if(HAL_GPIO_ReadPin(KEY2_GPIO_Port,GPIO_PIN_7)==0) key_tem=3;
		else if(HAL_GPIO_ReadPin(KEY3_GPIO_Port,GPIO_PIN_6)==0) key_tem=4;
